...
namespace ILConfessions.API.Migrations
{
    ...
    [Migration("20191219222159_AddKnownAsToConfessions")]
    partial class AddKnownAsToConfessions
    {
...
#pragma warning disable 612, 618
            ...
            modelBuilder.Entity("ILConfessions.API.Models.ApplicationUser", b =>
                {
            ...
            modelBuilder.Entity("Microsoft.AspNetCore.Identity.IdentityUserClaim<string>", b =>
                {
                    b.HasOne("ILConfessions.API.Models.ApplicationUser")
                        .WithMany()
                        .HasForeignKey("UserId")
                        .OnDelete(DeleteBehavior.Cascade);
                });
